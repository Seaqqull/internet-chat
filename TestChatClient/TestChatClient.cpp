...
// TestChatClient.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTestChatClientApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CTestChatClientApp

CTestChatClientApp::CTestChatClientApp()
{
...
// Единственный объект CTestChatClientApp

CTestChatClientApp theApp;


// инициализация CTestChatClientApp

BOOL CTestChatClientApp::InitInstance()
{
