...
// TestChat.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTestChatApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CTestChatApp

CTestChatApp::CTestChatApp()
{
...
// Единственный объект CTestChatApp

CTestChatApp theApp;


// инициализация CTestChatApp

BOOL CTestChatApp::InitInstance()
{
